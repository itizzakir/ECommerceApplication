export const products = [
  ...
  },
  {
    id: 101,
    title: "Leather Belt",
    description: "A classic leather belt for a stylish look.",
    price: 1299,
    discount: 10,
    stock: 100,
    category: "Accessories",
  ...
  },
  {
    id: 102,
    title: "Silk Scarf",
    description: "An elegant silk scarf to elevate your outfit.",
    price: 1599,
    discount: 15,
    stock: 80,
    category: "Accessories",
  ...
  },
  {
    id: 104,
    title: "Leather Gloves",
    description: "Stylish leather gloves to keep you warm.",
    price: 1999,
    discount: 20,
    stock: 60,
    category: "Accessories",
  ...
  },
  {
    ...
    description: "A bold statement necklace to complete your look.",
    price: 2599,
    discount: 25,
    stock: 40,
    category: "Accessories",
  ...
  },
  {
    ...
    description: "A luxurious designer watch for a timeless look.",
    price: 19999,
    discount: 10,
    stock: 20,
    category: "Accessories",
  ...
  },
  {
    id: 108,
    title: "Crossbody Bag",
    description: "A stylish crossbody bag for your essentials.",
    price: 3499,
    discount: 20,
    stock: 70,
    category: "Accessories",
  ...
  },
  {
    id: 109,
    title: "Fedora Hat",
    description: "A classic fedora hat for a stylish look.",
    price: 2299,
    discount: 10,
    stock: 50,
    category: "Accessories",
  ...
  },
  {
    ...
    description: "Elegant pearl earrings for a classic look.",
    price: 2999,
    discount: 15,
    stock: 60,
    category: "Accessories",
  ...
  },
  {
    ...
    description: "A stylish leather backpack for your daily commute.",
    price: 4999,
    discount: 20,
    stock: 40,
    category: "Accessories",
  ...
  },
  {
    id: 112,
    title: "Knit Scarf",
    description: "A cozy knit scarf to keep you warm.",
    price: 1399,
    discount: 10,
    stock: 110,
    category: "Accessories",
  ...
  },
  {
    id: 114,
    title: "Bow Tie",
    description: "A classic bow tie for a formal occasion.",
    price: 999,
    discount: 0,
    stock: 150,
    category: "Accessories",
  ...
  },
  {
    ...
    description: "A bold statement ring to complete your look.",
    price: 2499,
    discount: 20,
    stock: 50,
    category: "Accessories",
  ...
  },
  {
    id: 116,
    title: "Designer Belt",
    description: "A luxurious designer belt for a stylish look.",
    price: 3999,
    discount: 25,
    stock: 30,
    category: "Accessories",
  ...
  },
  {
    ...
    description: "Classic wayfarer sunglasses for a timeless look.",
    price: 1699,
    discount: 10,
    stock: 100,
    category: "Accessories",
  ...
  },
  {
    id: 118,
    title: "Tote Bag",
    description: "A spacious tote bag for your daily essentials.",
    price: 2899,
    discount: 15,
    stock: 80,
    category: "Accessories",
  ...
  },
  {
    id: 119,
    title: "Panama Hat",
    description: "A classic panama hat for a stylish summer look.",
    price: 2199,
    discount: 10,
    stock: 60,
    category: "Accessories",
  ...
  },
  {
    ...
    description: "A durable canvas backpack for your adventures.",
    price: 3999,
    discount: 15,
    stock: 50,
    category: "Accessories",
  ...
  },
  {
    ...
    description: "A luxurious cashmere scarf to keep you warm.",
    price: 2999,
    discount: 20,
    stock: 30,
    category: "Accessories",
  ...
  },
  {
    id: 123,
    title: "Tie",
    description: "A classic tie for a formal look.",
    price: 1299,
    discount: 10,
    stock: 90,
    category: "Accessories",
  ...
  },
  {
    id: 124,
    title: "Pocket Square",
    description: "An elegant pocket square to complete your look.",
    price: 799,
    discount: 0,
    stock: 120,
    category: "Accessories",
  ...
  },
  {
    ...
    description: "A beautiful charm bracelet to tell your story.",
    price: 3499,
    discount: 15,
    stock: 70,
    category: "Accessories",
  ...
  },
  {
    id: 126,
    title: "Woven Belt",
    description: "A stylish woven belt for a casual look.",
    price: 1199,
    discount: 10,
    stock: 100,
    category: "Accessories",
  ...
  },
  {
    ...
    description: "Stylish cat-eye sunglasses for a retro look.",
    price: 1999,
    discount: 20,
    stock: 80,
    category: "Accessories",
  ...
  },
  {
    id: 128,
    title: "Clutch Bag",
    description: "A chic clutch bag for a night out.",
    price: 2699,
    discount: 15,
    stock: 60,
    category: "Accessories",
  ...
  },
  {
    id: 130,
    title: "Hoop Earrings",
    description: "Classic hoop earrings for a timeless look.",
    price: 1899,
    discount: 15,
    stock: 70,
    category: "Accessories",
  ...
  },
  {
    id: 131,
    title: "Lipstick",
    description: "A vibrant lipstick to brighten up your look.",
    price: 999,
    discount: 10,
    stock: 100,
    category: "Cosmetics",
  ...
  },
  {
    id: 132,
    title: "Foundation",
    description: "A long-lasting foundation for a flawless complexion.",
    price: 1999,
    discount: 15,
    stock: 80,
    category: "Cosmetics",
  ...
  },
  {
    id: 133,
    title: "Mascara",
    description: "A volumizing mascara for luscious lashes.",
    price: 1299,
    discount: 0,
    stock: 120,
    category: "Cosmetics",
  ...
  },
  {
    id: 134,
    title: "Eyeliner",
    description: "A waterproof eyeliner for a dramatic look.",
    price: 899,
    discount: 10,
    stock: 100,
    category: "Cosmetics",
  ...
  },
  {
    ...
    description: "A versatile eyeshadow palette for endless looks.",
    price: 2999,
    discount: 20,
    stock: 60,
    category: "Cosmetics",
  ...
  },
  {
    id: 136,
    title: "Blush",
    description: "A natural-looking blush for a healthy glow.",
    price: 1499,
    discount: 15,
    stock: 90,
    category: "Cosmetics",
  ...
  },
  {
    id: 137,
    title: "Highlighter",
    description: "A shimmering highlighter for a radiant look.",
    price: 1799,
    discount: 10,
    stock: 70,
    category: "Cosmetics",
  ...
  },
  {
    id: 138,
    title: "Bronzer",
    description: "A sun-kissed bronzer for a healthy-looking tan.",
    price: 1699,
    discount: 0,
    stock: 80,
    category: "Cosmetics",
  ...
  },
  {
    id: 139,
    title: "Concealer",
    description: "A high-coverage concealer to hide imperfections.",
    price: 1199,
    discount: 10,
    stock: 110,
    category: "Cosmetics",
  ...
  },
  {
    id: 140,
    title: "Primer",
    description: "A smoothing primer for a flawless makeup base.",
    price: 1899,
    discount: 15,
    stock: 90,
    category: "Cosmetics",
  ...
  },
  {
    id: 141,
    title: "Setting Spray",
    description: "A long-lasting setting spray to keep your makeup in place.",
    price: 1599,
    discount: 0,
    stock: 100,
    category: "Cosmetics",
  ...
  },
  {
    ...
    description: "A set of professional makeup brushes for a flawless application.",
    price: 3999,
    discount: 20,
    stock: 50,
    category: "Cosmetics",
  ...
  },
  {
    id: 143,
    title: "Makeup Sponge",
    description: "A soft makeup sponge for a seamless blend.",
    price: 499,
    discount: 0,
    stock: 200,
    category: "Cosmetics",
  ...
  },
  {
    ...
    description: "A gentle makeup remover to cleanse your skin.",
    price: 999,
    discount: 10,
    stock: 150,
    category: "Cosmetics",
  ...
  },
  {
    id: 145,
    title: "Face Cleanser",
    description: "A gentle face cleanser for a fresh and clean feel.",
    price: 1299,
    discount: 15,
    stock: 100,
    category: "Cosmetics",
  ...
  },
  {
    id: 147,
    title: "Face Serum",
    description: "A powerful face serum to target your skin concerns.",
    price: 2499,
    discount: 25,
    stock: 60,
    category: "Cosmetics",
  ...
  },
  {
    id: 148,
    title: "Face Mask",
    description: "A relaxing face mask for a spa-like experience at home.",
    price: 799,
    discount: 0,
    stock: 150,
    category: "Cosmetics",
  ...
  },
  {
    id: 149,
    title: "Lip Balm",
    description: "A nourishing lip balm for soft and smooth lips.",
    price: 399,
    discount: 0,
    stock: 200,
    category: "Cosmetics",
  ...
  },
  {
    id: 150,
    title: "Nail Polish",
    description: "A long-lasting nail polish in a variety of shades.",
    price: 599,
    discount: 10,
    stock: 180,
    category: "Cosmetics",
